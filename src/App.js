...
const AlmaasQuranAcademy = () => {
  ...
  const coursesDetailed = [
    {
      ...
      image: "https://images.unsplash.com/photo-1609599006353-e629aaabfeae?w=600&h=300&fit=crop&q=80",
      whatYouLearn: [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1584286595398-a59f21d25e0d?w=600&h=300&fit=crop&q=80",
      whatYouLearn: [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1542816417-0983c9c9ad53?w=600&h=300&fit=crop&q=80",
      whatYouLearn: [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1604519373538-c0127f4d6c3a?w=600&h=300&fit=crop&q=80",
      whatYouLearn: [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1585508889824-e2c9b7c97dc5?w=600&h=300&fit=crop&q=80",
      whatYouLearn: [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1590650046871-92c887180603?w=600&h=300&fit=crop&q=80",
      whatYouLearn: [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1476357471311-43c0db9fb2b4?w=600&h=300&fit=crop&q=80",
      whatYouLearn: [
        "Rules of Tajweed",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1481627834876-b7833e8f5570?w=600&h=300&fit=crop&q=80",
      whatYouLearn: [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?w=600&h=300&fit=crop&q=80",
      whatYouLearn: [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1553729459-efe14ef6055d?w=600&h=300&fit=crop&q=80",
      whatYouLearn: [
        "Basic Islamic beliefs",
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="pt-24 pb-20 px-4">
          <div className="max-w-7xl mx-auto">
            <h1 className="text-5xl font-black text-blue-900 mb-4 text-center">Our Courses</h1>
            <p className="text-slate-700 text-lg text-center mb-12">Explore our comprehensive Islamic education programs</p>
            <div className="space-y-8">
              {coursesDetailed.map((course, idx) => (
                <div key={idx} className="bg-white border-2 border-blue-200 rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition">
                  <div className="md:flex">
                    ...
                    <div className="md:w-2/3 p-8">
                      <div className="flex items-start justify-between mb-4">
                        <h2 className="text-3xl font-black text-blue-900">{course.title}</h2>
                      ...
                      <p className="text-slate-700 mb-6 leading-relaxed">{course.fullDesc}</p>
                      ...
                      <div className="bg-blue-50 border-l-4 border-blue-900 p-4 mb-6">
                        <p className="text-slate-800 italic">{course.summary}</p>
                      </div>
                      
                      <button 
                        onClick={() => { setShowPopup(true); navigateTo('home'); }} 
                        className="w-full md:w-auto bg-gradient-to-r from-blue-900 to-blue-800 text-white py-3 px-8 rounded-xl font-bold hover:from-blue-800 hover:to-blue-700 transition shadow-lg flex items-center justify-center gap-2"
                      >
  ...
  if (currentPage === 'pricing') {
    return (
      <div className="min-h-screen bg-white">
        <button onClick={() => navigateTo('home')} className="fixed top-4 left-4 z-50 bg-blue-900 text-white px-4 py-2 rounded-lg flex items-center gap-2">
          <ArrowLeft className="w-4 h-4" /> Back
        </button>
        <div className="pt-24 pb-20 px-4">
          <div className="max-w-5xl mx-auto">
            <h1 className="text-5xl font-black text-blue-900 mb-8 text-center">Pricing Plans</h1>
            <div className="grid md:grid-cols-3 gap-6">
              {pricingPlans.map((plan, idx) => (
                <div key={idx} className={`rounded-2xl p-8 ${plan.popular ? 'bg-blue-900 text-white scale-105' : 'bg-white border-2 border-blue-200 text-slate-900'}`}>
                  ...
                  <div className="text-5xl font-black my-4">{plan.price}<span className="text-sm">/mo</span></div>
                  <ul className="space-y-3 mb-8">
                    {plan.features.map((f, i) => (
                      <li key={i} className="flex items-center"><CheckCircle className="w-5 h-5 mr-2" />{f}</li>
                    ))}
                  </ul>
                  <button className={`w-full py-3 rounded-lg font-bold ${plan.popular ? 'bg-white text-blue-900' : 'bg-blue-900 text-white'}`}>Choose Plan</button>
                </div>
              ))}
            </div>
          </div>
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="pt-24 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-5xl font-black text-blue-900 mb-8 text-center">FAQs</h1>
              ...
              {faqs.map((faq, idx) => (
                <div key={idx} className="bg-white border-2 border-blue-200 rounded-2xl overflow-hidden">
                  <button onClick={() => setActiveFaq(activeFaq === idx ? null : idx)} className="w-full p-6 text-left flex justify-between items-center">
                    <span className="text-blue-900 font-bold text-lg">{faq.q}</span>
                    <ChevronDown className={`w-6 h-6 text-blue-900 transition ${activeFaq === idx ? 'rotate-180' : ''}`} />
                  </button>
                  {activeFaq === idx && <div className="px-6 pb-6"><p className="text-slate-700">{faq.a}</p></div>}
                </div>
              ))}
            </div>
          </div>
  ...
  if (currentPage === 'blogs') {
    return (
      <div className="min-h-screen bg-white">
        ...
        <div className="pt-24 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-5xl font-black text-blue-900 mb-8 text-center">Latest Articles</h1>
            {blogs.map((blog) => (
              <article key={blog.id} className="bg-white border-2 border-blue-200 rounded-2xl p-8 mb-6">
                <Newspaper className="w-8 h-8 text-blue-900 mb-4" />
                <p className="text-sm text-blue-700 font-semibold mb-2">{blog.date}</p>
                <h2 className="text-3xl font-black text-blue-900 mb-4">{blog.title}</h2>
                <p className="text-slate-700 mb-4">{blog.excerpt}</p>
                <button className="bg-blue-900 text-white px-6 py-2 rounded-lg font-bold">Read More</button>
              </article>
            ))}
          </div>
        </div>
  ...
  if (currentPage === 'contact') {
    return (
      <div className="min-h-screen bg-white">
        ...
        <div className="pt-24 pb-20 px-4">
          <div className="max-w-5xl mx-auto">
            <h1 className="text-5xl font-black text-blue-900 mb-8 text-center">Contact Us</h1>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-6">
                <div className="bg-blue-50 border-2 border-blue-900 p-6 rounded-xl">
                  <Phone className="w-10 h-10 text-blue-900 mb-4" />
                  <h3 className="text-blue-900 font-bold text-lg mb-2">Call Us</h3>
                  <p className="text-slate-800">+92 315 2267416</p>
                </div>
                <div className="bg-blue-50 border-2 border-blue-900 p-6 rounded-xl">
                  <MessageCircle className="w-10 h-10 text-blue-900 mb-4" />
                  <h3 className="text-blue-900 font-bold text-lg mb-2">WhatsApp</h3>
                  <p className="text-slate-800">+92 335 0277160</p>
                </div>
              </div>
              <div className="bg-blue-50 border-2 border-blue-900 p-8 rounded-2xl">
                <form onSubmit={handleSubmit} className="space-y-4">
                  <input type="text" placeholder="First Name" className="w-full px-4 py-3 rounded-lg border-2 border-blue-900" required />
                  <input type="email" placeholder="Email" className="w-full px-4 py-3 rounded-lg border-2 border-blue-900" required />
                  <textarea placeholder="Message" rows="4" className="w-full px-4 py-3 rounded-lg border-2 border-blue-900" required></textarea>
                  <button type="submit" className="w-full bg-blue-900 text-white py-4 rounded-lg font-bold">Send Message</button>
                </form>
              </div>
            </div>
          </div>
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {showChat && (
        <div className="fixed bottom-24 right-6 z-50 bg-white rounded-2xl shadow-2xl w-80 border-2 border-blue-900">
      ...
      {showPopup && (
        <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4">
          <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-3xl p-8 max-w-md w-full relative max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <input type="text" placeholder="First Name" className="px-4 py-3 rounded-lg bg-white/10 border border-white/20 text-white placeholder-white/60" required />
                <input type="text" placeholder="Last Name" className="px-4 py-3 rounded-lg bg-white/10 border border-white/20 text-white placeholder-white/60" required />
              </div>
              <input type="email" placeholder="Email" className="w-full px-4 py-3 rounded-lg bg-white/10 border border-white/20 text-white placeholder-white/60" required />
              <select className="w-full px-4 py-3 rounded-lg bg-white/10 border border-white/20 text-white" required>
              ...
              <input type="tel" placeholder="Phone" className="w-full px-4 py-3 rounded-lg bg-white/10 border border-white/20 text-white placeholder-white/60" required />
              <textarea placeholder="Message" rows="3" className="w-full px-4 py-3 rounded-lg bg-white/10 border border-white/20 text-white placeholder-white/60"></textarea>
              <button type="submit" className="w-full bg-gradient-to-r from-amber-500 to-yellow-600 text-slate-900 py-4 rounded-lg font-bold">Submit Form</button>
            </form>
          </div>
        </div>
      )}
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-blue-900">ALMAAS ONLINE</h1>
                <p className="text-sm text-slate-700 font-medium">QURAN ACADEMY</p>
              </div>
            </div>
            <nav className="hidden lg:flex items-center gap-8">
              ...
              <button onClick={() => setShowPopup(true)} className="bg-blue-900 text-white px-6 py-2.5 rounded-lg font-bold">Start Free Trial</button>
            </nav>
      ...
      <section id="home" className="pt-32 pb-20 px-4 bg-gradient-to-br from-blue-50 to-white">
        <div className="max-w-7xl mx-auto text-center">
          <div className="mb-12">
            <p className="text-6xl md:text-7xl mb-4" style={{fontFamily: "'Scheherazade New', 'Noto Naskh Arabic', 'Traditional Arabic', 'Amiri', serif", fontWeight: 700, color: '#1e3a8a', lineHeight: 1.8, letterSpacing: '0.02em'}}>
              بِسْمِ اللَّهِ الرَّحْمَـٰنِ الرَّحِيمِ
            </p>
            <p className="text-base text-slate-700 font-semibold">In the name of Allah, the Most Gracious, the Most Merciful</p>
          </div>

          <h1 className="text-4xl md:text-5xl lg:text-6xl font-black leading-tight mb-6">
            {/* Animated Tagline */}
            <div className="overflow-hidden h-16 md:h-20 lg:h-24 relative mb-4">
              {taglines.map((tagline, idx) => (
                ...
                >
                  <span className="text-blue-900 block">{tagline}</span>
                </div>
              ))}
            </div>
            <span className="text-blue-800 block text-3xl md:text-4xl lg:text-5xl mb-4">With</span>
            <span className="bg-gradient-to-r from-amber-500 via-yellow-500 to-amber-600 bg-clip-text text-transparent block text-4xl md:text-5xl lg:text-6xl">
              Almaas Online Quran Academy
            </span>
          </h1>

          <p className="text-lg text-blue-900 mb-4 font-bold max-w-3xl mx-auto">
            One-on-one and group classes are available for kids and adults.
          </p>

          <p className="text-slate-700 mb-8 font-medium max-w-3xl mx-auto">
            Expert teachers • Flexible timings • Affordable pricing • 24/7 availability
          </p>

          <button onClick={() => setShowPopup(true)} className="bg-blue-900 hover:bg-blue-800 text-white px-8 py-4 rounded-lg font-bold text-lg inline-flex items-center gap-2 shadow-xl">
          ...
          <div className="mt-12 flex items-center justify-center gap-3 bg-green-50 border-2 border-green-600 px-6 py-3 rounded-xl max-w-md mx-auto">
            ...
            <div className="text-left">
              <p className="text-slate-900 font-bold">7-Day Money-Back Guarantee</p>
              <p className="text-green-700 text-sm font-semibold">100% Risk-Free Trial</p>
            </div>
          </div>

          <div className="mt-8 bg-white border-2 border-blue-200 px-6 py-4 rounded-xl max-w-2xl mx-auto">
            <p className="text-slate-700 text-sm mb-3 font-semibold">We Accept:</p>
            <div className="flex gap-4 items-center justify-center flex-wrap">
              <CreditCard className="w-8 h-8 text-blue-900" />
              <span className="text-slate-800 font-bold">Visa</span>
              <span className="text-slate-800 font-bold">Mastercard</span>
              <span className="text-slate-800 font-bold">PayPal</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 mt-8 max-w-2xl mx-auto">
            {[
              ...
              <div key={idx} className="bg-white border-2 border-blue-200 hover:border-blue-900 p-4 rounded-xl transition">
                <div className="text-3xl font-black text-blue-900">{stat.num}</div>
                <div className="text-xs text-blue-800 font-bold mt-1">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-slate-700 text-lg text-center mb-12">What makes us different from others</p>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              return (
                <div key={idx} className="bg-blue-50 border-2 border-blue-200 hover:border-blue-900 p-6 rounded-2xl transition">
                  <div className="w-16 h-16 bg-blue-900 rounded-xl flex items-center justify-center mb-4">
      ...
      <section className="py-20 px-4 bg-blue-50">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-slate-700 text-lg text-center mb-12">Get started in 4 simple steps</p>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              return (
                <div key={idx} className="bg-white border-2 border-blue-900 p-6 rounded-2xl text-center">
                  <div className="w-16 h-16 bg-blue-900 rounded-full flex items-center justify-center text-white text-2xl font-black mx-auto mb-4">{step.num}</div>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-slate-700 text-lg text-center mb-12">Comprehensive features for effective learning</p>
      ...
      <section className="py-20 px-4 bg-blue-50">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-slate-700 text-lg text-center mb-12">Comprehensive Quran learning programs</p>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {coursesDetailed.map((course, idx) => (
              <div key={idx} className="bg-gradient-to-br from-blue-800 to-blue-900 rounded-3xl overflow-hidden shadow-2xl border-4 border-white hover:scale-105 transition-transform">
                {/* Course Image */}
                ...
                {/* Course Content */}
                <div className="p-6">
                  <h3 className="text-2xl font-black text-yellow-400 mb-4">{course.title}</h3>
                  ...
                  <div className="flex gap-3">
                    <button 
                      ...
                      className="flex-1 bg-gradient-to-r from-yellow-500 to-amber-600 hover:from-yellow-600 hover:to-amber-700 text-blue-900 py-3 px-4 rounded-xl font-bold transition shadow-lg"
                    >
                      Start Now
                    </button>
                    <button 
                      onClick={() => navigateTo('courses')} 
                      className="flex-1 bg-white hover:bg-gray-100 text-blue-900 py-3 px-4 rounded-xl font-bold transition shadow-lg"
                    >
                      Read More
                    </button>
                  </div>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-slate-700 text-lg text-center mb-12">Choose the plan that fits your schedule</p>
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {pricingPlans.map((plan, idx) => (
              <div key={idx} className={`rounded-2xl p-8 transition ${plan.popular ? 'bg-blue-900 text-white scale-105 shadow-2xl' : 'bg-white border-2 border-blue-200 text-slate-900'}`}>
                {plan.popular && <span className="bg-white text-blue-900 px-3 py-1 rounded-full text-xs font-bold">Most Popular</span>}
                <h3 className="text-2xl font-black mt-4 mb-2">{plan.name}</h3>
                <div className="mb-6"><span className="text-5xl font-black">{plan.price}</span><span className="text-sm">/month</span></div>
                <ul className="space-y-3 mb-8">
                  {plan.features.map((f, i) => (
                    <li key={i} className="flex items-center text-sm">
                      <CheckCircle className={`w-5 h-5 mr-2 ${plan.popular ? 'text-white' : 'text-blue-900'}`} />
                      {f}
                    </li>
                  ))}
                </ul>
                <button onClick={() => setShowPopup(true)} className={`w-full py-3 rounded-lg font-bold transition ${plan.popular ? 'bg-white text-blue-900 hover:bg-gray-100' : 'bg-blue-900 text-white hover:bg-blue-800'}`}>
                  Choose Plan
                </button>
              </div>
            ))}
      ...
      <section className="py-20 px-4 bg-blue-50">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-slate-700 text-lg text-center mb-12">Find answers to common questions</p>
          <div className="space-y-4">
            {faqs.map((faq, idx) => (
              <div key={idx} className="bg-white border-2 border-blue-200 rounded-2xl overflow-hidden">
                <button onClick={() => setActiveFaq(activeFaq === idx ? null : idx)} className="w-full p-6 text-left flex justify-between items-center hover:bg-blue-50 transition">
                  <span className="text-blue-900 font-bold text-lg">{faq.q}</span>
                  <ChevronDown className={`w-6 h-6 text-blue-900 transition-transform ${activeFaq === idx ? 'rotate-180' : ''}`} />
                </button>
                {activeFaq === idx && <div className="px-6 pb-6"><p className="text-slate-700 leading-relaxed">{faq.a}</p></div>}
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-slate-700 text-lg text-center mb-12">Read our latest insights and tips</p>
          <div className="grid md:grid-cols-3 gap-8">
            {blogs.map((blog, idx) => (
              <div key={idx} className="bg-white border-2 border-blue-200 hover:border-blue-900 rounded-2xl overflow-hidden transition">
                ...
                <div className="p-6">
                  <p className="text-blue-900 text-sm mb-2 font-semibold">{blog.date}</p>
                  <h3 className="text-xl font-bold text-blue-900 mb-3">{blog.title}</h3>
                  <p className="text-slate-700 text-sm mb-4">{blog.excerpt}</p>
                  <button onClick={() => navigateTo('blogs')} className="text-blue-900 font-bold flex items-center gap-2">
      ...
      <section className="py-20 px-4 bg-blue-50">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-slate-700 text-lg text-center mb-12">Have questions? Contact us directly!</p>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <a href="tel:+923152267416" className="block bg-white border-2 border-blue-900 p-6 rounded-xl hover:bg-blue-50 transition">
                <Phone className="w-10 h-10 text-blue-900 mb-4" />
                <h3 className="text-blue-900 font-bold text-lg mb-2">Call Us</h3>
                <p className="text-slate-800">+92 315 2267416</p>
              </a>
              <a href="https://wa.me/923350277160" target="_blank" rel="noopener noreferrer" className="block bg-white border-2 border-blue-900 p-6 rounded-xl hover:bg-blue-50 transition">
                <MessageCircle className="w-10 h-10 text-blue-900 mb-4" />
                <h3 className="text-blue-900 font-bold text-lg mb-2">WhatsApp</h3>
                <p className="text-slate-800">+92 335 0277160</p>
              </a>
            ...
            <div className="bg-white border-2 border-blue-900 p-8 rounded-2xl">
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <input type="text" placeholder="First Name" className="px-4 py-3 rounded-lg border-2 border-blue-200 focus:border-blue-900 focus:outline-none" required />
                  <input type="text" placeholder="Last Name" className="px-4 py-3 rounded-lg border-2 border-blue-200 focus:border-blue-900 focus:outline-none" required />
                </div>
                <input type="email" placeholder="Email" className="w-full px-4 py-3 rounded-lg border-2 border-blue-200 focus:border-blue-900 focus:outline-none" required />
                <select className="w-full px-4 py-3 rounded-lg border-2 border-blue-200 focus:border-blue-900 focus:outline-none" required>
                  <option value="">Select Course</option>
                  {courses.map((c, i) => <option key={i} value={c.value}>{c.title}</option>)}
                </select>
                <input type="tel" placeholder="Phone" className="w-full px-4 py-3 rounded-lg border-2 border-blue-200 focus:border-blue-900 focus:outline-none" required />
                <textarea placeholder="Message" rows="4" className="w-full px-4 py-3 rounded-lg border-2 border-blue-200 focus:border-blue-900 focus:outline-none resize-none"></textarea>
                <button type="submit" className="w-full bg-blue-900 text-white py-4 rounded-lg font-bold text-lg shadow-xl hover:bg-blue-800 transition">
                  Send Message
                </button>
              </form>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <div className="flex gap-3">
                <a href="https://www.facebook.com/share/1QTAHW4p7t/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-slate-800 hover:bg-blue-600 rounded-full flex items-center justify-center"><Facebook className="w-5 h-5" /></a>
                <a href="https://www.instagram.com/almaasonlinequranacademy" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-slate-800 hover:bg-pink-600 rounded-full flex items-center justify-center"><Instagram className="w-5 h-5" /></a>
                <a href="https://youtube.com/@hafizraheelshah" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-slate-800 hover:bg-red-600 rounded-full flex items-center justify-center"><Youtube className="w-5 h-5" /></a>
              </div>
            </div>
            <div>
